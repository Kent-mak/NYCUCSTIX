class Tasks:
    def __init__(self):
        # init
        self.StoreApple = [0 for i in range(110)]
        self.StoreStar = [0 for i in range(110)]
        self.StoreAdvanceStar = [0 for i in range(55)]
    ...
    def apple(self):
        for number in range(30, 101):
            ...
            self.StoreApple[number] = int(money)
    ...
    def star_advance(self):
        for number in range(1, 51):
            ...
            for i in range(number):
                ...
                if i != number - 1:
                    ans = ans + "\n"
            self.StoreAdvanceStar[number] = ans
